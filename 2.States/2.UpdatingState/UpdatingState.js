class DetailsBox extends React.Component {
	...
	pickRandomColor = () => {
		var colors = ['blue', 'magenta', 'lavender', 'voilet', 'red'];
	...
	pickRandomBackgroundColor = () => {
		var colors = ['lime', 'skyblue', 'orange', 'yellow', 'purple'];
	...
	pickRandomSubject = () => {
		var subjects = ['Biology', 'Mathematics', 'Chemistry', 'Physics', 'Urdu', 'English'];
		// 'Math', 'Science', 'Biochemistry', 'Physics', 'History', 'Pyschology'
	...
	render() {
		...
		return (
			<div>
				...
				<button className = "button" onClick = {this.pickRandomColor}> Change Text Color </button>
